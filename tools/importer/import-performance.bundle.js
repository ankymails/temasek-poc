...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-performance.js
  var import_performance_exports = {};
  __export(import_performance_exports, {
    default: () => import_performance_default
  });

  // tools/importer/parsers/callout-case-study.js
  ...
  // tools/importer/parsers/logo-grid.js
  ...
  var PAGE_TEMPLATE = {
    name: "chapter-page",
    description: "Temasek Review chapter page \u2014 Performance & Portfolio",
    urls: ["https://www.temasekreview.com.sg/performance-and-portfolio.html"],
    autoAccordion: true,
    blocks: [
      {
        name: "chapter-nav",
  ...
  var import_performance_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_performance_exports);
})();
