...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-media-centre.js
  var import_media_centre_exports = {};
  __export(import_media_centre_exports, {
    default: () => import_media_centre_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "chapter-page",
    description: "Temasek Review chapter page \u2014 Media Centre",
    urls: ["https://www.temasekreview.com.sg/media-centre.html"],
    autoAccordion: true,
    blocks: [
      {
        name: "chapter-nav",
  ...
  var import_media_centre_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_media_centre_exports);
})();
