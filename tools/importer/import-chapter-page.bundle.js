...
var CustomImportScript = (() => {
  ...
  var import_chapter_page_exports = {};
  __export(import_chapter_page_exports, {
    default: () => import_chapter_page_default
  });
  ...
  var import_chapter_page_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_chapter_page_exports);
})();
