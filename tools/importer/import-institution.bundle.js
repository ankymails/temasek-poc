...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-institution.js
  var import_institution_exports = {};
  __export(import_institution_exports, {
    default: () => import_institution_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "chapter-page",
    description: "Temasek Review chapter page \u2014 Institution",
    urls: ["https://www.temasekreview.com.sg/institution.html"],
    autoAccordion: true,
    blocks: [
      {
        name: "chapter-nav",
  ...
  var import_institution_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_institution_exports);
})();
